...
export const schedule = [
  ...
  },
  {
    ...
    exercises: [
      ...
      { name: "Incline Dumbbell Press", category: "Compound Bilateral", order: 3, sets: 3, reps: "8–12", rest: "2 min", eccentric: "3s down", note: "Same form as Monday. Shoulder compounds came first so expect slightly less load.", why: "Second weekly upper chest session. Placed third after shoulder compounds since chest is secondary today.", form: [{ label: "Form", text: "Same as Monday. Bench at 30–45°, scapular retraction held, 3-second descent." }, { label: "Load", text: "Expect to use slightly less than Monday since shoulder work came first — log both." }] },
      { name: "Single-Arm Overhead DB Press", category: "Compound Unilateral", order: 4, sets: 3, reps: "10–12 each side", rest: "90 sec", eccentric: "3s down", imbalanceNote: IMBALANCE_NOTE, note: "Identical to Monday. Log left and right weights separately — the gap should narrow week over week.", why: "Second weekly unilateral shoulder check. Log each side separately and compare to Monday — if the gap is narrowing, the correction is working.", form: [{ label: "Form", text: "Identical to Monday. Core braced hard before every rep, no lateral torso lean." }, { label: "Track", text: "Log left and right weights separately. The goal over 8–12 weeks is both sides matching." }] },
      ...
      { name: "Cable Fly (Low-to-High)", category: "Isolation Bilateral", order: 6, sets: 3, reps: "12–15", rest: "90 sec", eccentric: "2s return", note: "Same as Monday — cable at the lowest position, sweep up and across, full squeeze at the top.", why: "Second weekly chest isolation. Bilateral to keep it efficient.", form: [] },
      { name: "Tricep Rope Pushdown", category: "Isolation Bilateral", order: 7, sets: 3, reps: "12–15", rest: "90 sec", eccentric: "2s return", note: "Same as Monday. Elbows pinned to ribs, spread the rope at full extension.", why: "Second weekly tricep isolation — lateral and medial head focus. Different stimulus from Monday's overhead extension.", form: [] },
    ],
  core_finisher: [
  ...
  },
  {
    ...
    exercises: [
      { name: "Leg Press", category: "Compound Bilateral", order: 1, sets: 4, reps: "8–10", rest: "2–3 min", eccentric: "3s down", note: "Slightly lower foot position than Wednesday for more quad bias. Same core brace — lower back stays on the pad.", why: "Quad-focused bilateral compound placed first today. Lower rep range and higher load than Wednesday for a different stimulus.", form: [] },
      { name: "Hip Thrust (Barbell or Machine)", category: "Compound Bilateral", order: 2, sets: 3, reps: "10–12", rest: "2 min", eccentric: "3s down", note: "Same form as Wednesday. Glutes are pre-fatigued from leg press so slightly less load is normal. Still aim to beat last Saturday.", why: "Second weekly glute compound. Glutes handle high frequency well and need the volume. Progressive overload still applies.", form: [] },
      { name: "Bulgarian Split Squat (Dumbbell)", category: "Compound Unilateral", order: 3, sets: 3, reps: "10–12 each leg", rest: "90 sec", eccentric: "3s down", imbalanceNote: IMBALANCE_NOTE, note: "Higher rep range than Wednesday — same weight or slightly less. Left leg first. Today is the volume day for this movement.", why: "Second weekly unilateral leg session. Higher rep range than Wednesday for additional volume. Left leg first every time.", form: [] },
